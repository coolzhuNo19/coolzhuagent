...
impl PermissionProfile {
    ...
    pub fn as_str(self) -> &'static str {
        match self {
            Self::WorkspaceAuto => "workspace-auto",
            Self::OutsideApproval => "outside-approval",
    ...
    pub fn from_str(s: &str) -> Option<Self> {
        match s {
            "workspace-auto" | "WorkspaceAuto" | "workspace_auto" => Some(Self::WorkspaceAuto),
            "outside-approval" | "OutsideApproval" | "outside_approval" => {
                Some(Self::OutsideApproval)
            }
