...
[ordered]@{
    ...
    resources = @(
        ...
        [ordered]@{ id = 'frontend-index'; source = 'modules/gui-web/packages/web-console/index.html'; target = 'modules/gui-web/packages/web-console/index.html' },
        [ordered]@{ id = 'frontend-app'; source = 'modules/gui-web/packages/web-console/src/app.js'; target = 'modules/gui-web/packages/web-console/src/app.js' },
        [ordered]@{ id = 'frontend-styles'; source = 'modules/gui-web/packages/web-console/src/styles.css'; target = 'modules/gui-web/packages/web-console/src/styles.css' },
        [ordered]@{ id = 'frontend-capture'; source = 'modules/gui-web/packages/web-console/src/realtime_voice_capture.js'; target = 'modules/gui-web/packages/web-console/src/realtime_voice_capture.js' },
        [ordered]@{ id = 'frontend-output'; source = 'modules/gui-web/packages/web-console/src/realtime_audio_output.js'; target = 'modules/gui-web/packages/web-console/src/realtime_audio_output.js' },
        [ordered]@{ id = 'frontend-tail'; source = 'modules/gui-web/packages/web-console/src/stt_tail_capture.js'; target = 'modules/gui-web/packages/web-console/src/stt_tail_capture.js' },
        [ordered]@{ id = 'frontend-icon'; source = 'modules/gui-web/packages/web-console/assets/icons/code.png'; target = 'modules/gui-web/packages/web-console/assets/icons/code.png' }
    )
